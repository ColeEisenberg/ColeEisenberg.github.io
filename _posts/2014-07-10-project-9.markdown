...
alt1: image-alt1
img2: BackShot.png
paragraph2: This was one of the earliest working prototypes. I’ve learned to design and solder custom PCBs for this project, with successful results. Keep in mind this is only a prototype—there are more refined versions of this project in the pipeline.
paragraph3:
alt2: image-alt2
---
